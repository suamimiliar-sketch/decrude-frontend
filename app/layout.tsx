...
export const metadata: Metadata = {
  title: "Decrude | Foto Natal AI Indonesia",
  description: "Buat foto natal keluarga pakai AI, cuma 10 ribuan.",
};
  ...
  return (
    <html lang="id">
      <body className={`${geistSans.variable} ${geistMono.variable} antialiased`}>
        ...
        <a
          href="https://wa.me/6281234567890?text=Halo%20Decrude,%20mau%20tanya%20dong"
          target="_blank"
        ...
        >
          ...
          <span className="font-semibold text-sm hidden md:inline">Butuh Bantuan?</span>
        </a>
      </body>
    </html>
  );
